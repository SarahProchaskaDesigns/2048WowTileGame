...
export function firstPassFilter(arr){
...
export function addLikeNumbers(arr){
...
export function addSpaces(arr, moveDirection){
    var newArray = arr.slice();
...
export function rotateBoardCounterClockwise(arr){
...
export function rotateBoardClockwise(arr){
...
export function populateNewSquare(arr){
...
export function anyMove(totalBoardArray, move){
